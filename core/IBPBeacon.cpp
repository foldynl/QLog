...
const QList<IBPBeacon::Station> &IBPBeacon::beacons()
{
    ...
    static const QList<Station> beacons = QList<Station>()
                                          ...
                                          << Station(QStringLiteral("ZL6B"), -41.04350, 175.5952, false)
                                          ...
                                          << Station(QStringLiteral("4S7B"), 6.8915, 79.8559, true)
                                          << Station(QStringLiteral("ZS6DN"), -26.6531, 27.9474, true)
                                          << Station(QStringLiteral("5Z4B"), -1.2687, 36.8094, false)
                                          << Station(QStringLiteral("4X6TU"), 32.0622, 34.8069, true)
                                          << Station(QStringLiteral("OH2B"), 60.2920, 24.3942, true)
                                          ...
                                          << Station(QStringLiteral("YV5B"), 9.0964, -67.8239, true);
